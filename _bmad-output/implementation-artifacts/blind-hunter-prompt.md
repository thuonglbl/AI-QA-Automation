...
Execute the `bmad-review-adversarial-general` skill.
You must review the code changes provided. You have NO project context, just the diff. Focus strictly on code-level issues, security, syntax, obvious logic errors, and best practices.

Please review the diff found in `diff_output.txt` in this folder.
