...
Review Story 12.5 project-scoped artifact service changes with read access to the project. Focus only on unhandled edge cases, branching paths, boundary conditions, concurrency, storage/DB consistency, authorization boundary cases, and API input/output edge cases.
