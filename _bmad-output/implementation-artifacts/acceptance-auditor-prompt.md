...
**Spec file:** `5-1-browser-use-agent-configuration-and-session-management.md`
...
- Create `src/ai_qa/browser/` module with agent.py and session.py
- Add chrome_path and browser_timeout to AppSettings in config.py
- Add SessionError and NavigationError to exceptions.py
- Update .env.example with browser configuration options
- Create unit tests for browser agent and session management
