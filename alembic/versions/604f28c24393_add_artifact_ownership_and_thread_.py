...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_artifacts_created_by_user_id"), "artifacts", ["created_by_user_id"], unique=False
    )
    op.create_index(op.f("ix_artifacts_thread_id"), "artifacts", ["thread_id"], unique=False)
    op.create_index(
        op.f("ix_artifacts_updated_by_user_id"), "artifacts", ["updated_by_user_id"], unique=False
    )
    op.create_foreign_key(
        op.f("fk_artifacts_updated_by_user_id_users"),
        "artifacts",
        "users",
        ["updated_by_user_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("fk_artifacts_created_by_user_id_users"),
        "artifacts",
        "users",
        ["created_by_user_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("fk_artifacts_thread_id_threads"),
        "artifacts",
        "threads",
        ["thread_id"],
        ["id"],
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        op.f("fk_artifacts_created_by_user_id_users"), "artifacts", type_="foreignkey"
    )
    op.drop_constraint(
        op.f("fk_artifacts_updated_by_user_id_users"), "artifacts", type_="foreignkey"
    )
