...
_SCORES: list[tuple[str, str, float]] = [
    ...
    ("ask-your-confluence", "coding", 0.0),
    ("ask-your-confluence", "fast", 0.0),
    ("ask-your-confluence", "global", 0.0),
    ("ask-your-confluence", "instruction", 0.0),
    ("ask-your-confluence", "reasoning", 0.0),
    ("ask-your-confluence", "vision", 0.0),
    ("ask-your-jira", "coding", 0.0),
    ("ask-your-jira", "fast", 0.0),
    ("ask-your-jira", "global", 0.0),
    ("ask-your-jira", "instruction", 0.0),
    ("ask-your-jira", "reasoning", 0.0),
    ("ask-your-jira", "vision", 0.0),
    ("chat-with-mcp", "coding", 0.0),
    ("chat-with-mcp", "fast", 0.0),
    ("chat-with-mcp", "global", 0.0),
    ("chat-with-mcp", "instruction", 0.0),
    ("chat-with-mcp", "reasoning", 0.0),
    ("chat-with-mcp", "vision", 0.0),
    ...
    ("on-premises-gpt-osslatest", "coding", 0.0),
    ("on-premises-gpt-osslatest", "fast", 0.0),
    ("on-premises-gpt-osslatest", "global", 0.0),
    ("on-premises-gpt-osslatest", "instruction", 0.0),
    ("on-premises-gpt-osslatest", "reasoning", 0.0),
    ("on-premises-gpt-osslatest", "vision", 0.0),
]
